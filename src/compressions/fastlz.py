from .utils import (
    bytes_to_hex as _bytes_to_hex,
    finish_forwarder,
    hex_string as _hex_string,
    norm_hex,
)
...
def flz_fwd_bytecode(address: str) -> str:
    return finish_forwarder(
        "365f73"
        + norm_hex(address)
        + "815b838110602f575f80848134865af1{return_code}"
    )
